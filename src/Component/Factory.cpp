...
std::map<std::string, std::function<std::unique_ptr<nts::IComponent>(void)>> Factory::factory_list {
    ...
    std::make_pair("4013", []() {return std::make_unique<FlipFlop_4013>();}),
    std::make_pair("4069", []() {return std::make_unique<Inverter_4069>();}),
    std::make_pair("4017", []() {return std::make_unique<Johnson_4017>();}),
    std::make_pair("4011", []() {return std::make_unique<Nand_4011>();}),
    std::make_pair("4001", []() {return std::make_unique<Nor_4001>();}),
    std::make_pair("4071", []() {return std::make_unique<Or_4071>();}),
    std::make_pair("4801", []() {return std::make_unique<RAM_4801>();}),
    std::make_pair("4094", []() {return std::make_unique<Register_4094>();}),
    std::make_pair("2716", []() {return std::make_unique<ROM_2716>();}),
    std::make_pair("4512", []() {return std::make_unique<Selector_4512>();}),
    std::make_pair("4030", []() {return std::make_unique<Xor_4030>();}),
