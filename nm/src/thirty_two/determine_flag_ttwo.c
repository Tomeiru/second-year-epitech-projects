...
void determine_flag_ttwo_fot(symbol_ttwo_t **node, int toggle)
{
    symbol_ttwo_t *temp = *node;
...
void determine_flag_ttwo_thd(symbol_ttwo_t **node, int toggle)
{
    symbol_ttwo_t *temp = *node;
    ...
    determine_flag_ttwo_fot(node, toggle);

}

void determine_flag_ttwo_snd(symbol_ttwo_t **node, int toggle)
{
    symbol_ttwo_t *temp = *node;
    ...
    determine_flag_ttwo_thd(node, toggle);
}
...
void determine_flag_ttwo(symbol_ttwo_t **node)
{
    ...
    determine_flag_ttwo_snd(node, toggle);
}