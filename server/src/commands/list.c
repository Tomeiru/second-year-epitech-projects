...
const command_t COMMANDS[COMMANDS_NB] = {
    ...
    {LOGOUT_ID, 0, logout_cmd},
    {CREATE_TEAM_ID, sizeof(create_team_cmd_arg_t), create_team_cmd},
    {CREATE_CHANNEL_ID, sizeof(create_channel_cmd_arg_t), create_channel_cmd},
    {CREATE_THREAD_ID, sizeof(create_thread_cmd_arg_t), create_thread_cmd},
    {CREATE_CHANNEL_ID, sizeof(create_comment_cmd_arg_t), create_comment_cmd},
