...
SOURCE_FILES += ftrace/syscall/print_start_arguments ftrace/process/is_raw
...
SOURCE_FILES += ftrace/syscall/print_sys/execve
SOURCE_FILES += ftrace/syscall/print_sys/do_execve ftrace/syscall/print_path
SOURCE_FILES += ftrace/syscall/print_argv ftrace/syscall/print_argc
SOURCE_FILES += ftrace/syscall/print_address ftrace/syscall/print_path_n
SOURCE_FILES += ftrace/syscall/print_array_next
SOURCE_FILES += ftrace/syscall/print_more_data_after_this
SOURCE_FILES += ftrace/syscall/print_address_comment
SOURCE_FILES += ftrace/syscall/print_array_begin ftrace/syscall/print_string
SOURCE_FILES += ftrace/syscall/print_array_end ftrace/copy_mem_from_pid
SOURCE_FILES += ftrace/copy_str_from_pid ftrace/printf_comment
SOURCE_FILES += ftrace/syscall/print_quoted_c_string ftrace/quote_string
SOURCE_FILES += ftrace/syscall/print_comment_begin
SOURCE_FILES += ftrace/syscall/print_comment_end
SOURCE_FILES += ftrace/syscall/print_quoted_string ftrace/is_printable
SOURCE_FILES += ftrace/sprint_byte_octal ftrace/syscall/print_unavailable
SOURCE_FILES += ftrace/syscall/print_arguments_decimal
SOURCE_FILES += ftrace/syscall/print_sys/write ftrace/syscall/print_string_n
SOURCE_FILES += ftrace/syscall/print_string_ex ftrace/syscall/print_sys/brk
SOURCE_FILES += ftrace/syscall/print_sys/arch_prctl
SOURCE_FILES += ftrace/syscall/print_enum_value ftrace/enum_lookup
SOURCE_FILES += ftrace/syscall/print_sys/access ftrace/syscall/print_flags
SOURCE_FILES += ftrace/syscall/print_sys/openat ftrace/sprint_flags
SOURCE_FILES += ftrace/syscall/print_dir_fd ftrace/syscall/print_umode_t
SOURCE_FILES += ftrace/appendf_string_get_position_difference
SOURCE_FILES += ftrace/syscall/print_sys/newfstatat
SOURCE_FILES += ftrace/syscall/do_struct_stat ftrace/copy_struct_stat_from_pid
SOURCE_FILES += ftrace/syscall/print_struct_stat
SOURCE_FILES += ftrace/syscall/copy_mem_or_print_address
SOURCE_FILES += ftrace/syscall/print_struct_start
SOURCE_FILES += ftrace/syscall/print_symbolic_mode_t
SOURCE_FILES += ftrace/syscall/print_struct_next
SOURCE_FILES += ftrace/syscall/print_struct_end ftrace/syscall/print_sys/mmap
SOURCE_FILES += ftrace/syscall/print_sys/close ftrace/syscall/print_sys/read
SOURCE_FILES += ftrace/syscall/print_sys/pread
SOURCE_FILES += ftrace/syscall/print_sys/mprotect
SOURCE_FILES += ftrace/syscall/print_sys/munmap
SOURCE_FILES += ftrace/syscall/print_sys/prlimit64 ftrace/syscall/print_rlimit
SOURCE_FILES += ftrace/syscall/print_rlim_t ftrace/syscall/print_sys/getrandom
SOURCE_FILES += ftrace/sprint_byte_hex ftrace/syscall/print_sys/futex
